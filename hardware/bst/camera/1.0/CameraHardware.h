...
public:
    ...
    int getMaxWidth();
    void modifyParameters(CameraParameters *params);
    int setHostCamVFlip(int rotation);
    int setRotationAngle();
private:
...
public:
     ...
     */
    CameraHardware(const hw_module_t* module, char* devLocation, int facing);
