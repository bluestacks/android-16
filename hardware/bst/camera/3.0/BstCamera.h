...
#ifndef _BST_CAMERA_H
#define _BST_CAMERA_H

#include "Camera.h"
#include "MMAPStream.h"

class BstCamera : public Camera
{
 public:
    BstCamera(int32_t id, int32_t facing, int32_t orientation, char* path);
    ~BstCamera();
 ...
 private:
    class OvStream : public MMAPStream {
     public:
        ...
        // configure device.
        virtual int32_t onDeviceConfigureLocked(int id);
    };
};
